---
name: flow-review
description: 'Generate ASCII flow diagrams of changed code so the user can understand what the logic actually does before reviewing or approving. Invoke this skill whenever an implementation step completes — feature added, logic changed, bug fixed, refactor done — especially before the user is asked to approve or merge anything. Also trigger on: "show me the flow", "what did you change", "walk me through what you built", "I want to understand this before approving", "explain the logic", "what does this do". The goal is to replace blind approval with genuine understanding of underlying principles.'
---
